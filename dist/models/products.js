...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot find product " + id + ". Error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductStore.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, args, result, newProduct, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        args = [product.name, product.price, product.category];
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add user " + product.name + ". Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
